class Maquina_D{
    ...
    constructor(){
        ...
        var rectangulo2 = new Rectangulo(gl,0.3,0.1,1,[0.2,0.5,0.51]);
        var rectangulo3 = new Rectangulo(gl,0.5,0.5,0.1,[0,1,0]);
    ...
    configurarEscena(){
        ...
        this.caja3.trasladar([0,0,3]);

        this.maquinaE.trasladar([0,1.5,1.3]);
        this.maquinaE.escalar([0.8,0.8,0.8]);
        this.maquinaE.rotar(1.55,[1,0,0]);

        this.maquinaD.trasladar([-4,-3.5,0]);  
    }
